  ...
  return (
    <div className="p-4 border-t border-slate-800/60 bg-slate-900/80 backdrop-blur-sm">
      <div className="flex items-end gap-3 glass rounded-2xl border border-slate-700/60 px-4 py-3 focus-within:border-indigo-500/50 transition-all duration-200">
        ...
        {/* Mic */}
        <button
          className="shrink-0 p-1.5 text-slate-500 hover:text-indigo-400 transition-colors rounded-lg hover:bg-slate-800"
          title="Voice input"
        >
          <Mic size={18} />
        </button>
      ...
      <p className="text-center text-xs text-slate-700 font-body mt-2">
        Press <kbd className="font-mono bg-slate-800 px-1 py-0.5 rounded text-slate-500">Enter</kbd> to send,{" "}
        <kbd className="font-mono bg-slate-800 px-1 py-0.5 rounded text-slate-500">Shift+Enter</kbd> for new line
      </p>
    </div>
  );
}
